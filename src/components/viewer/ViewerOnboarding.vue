      ...
      >
        <div ref="panelRef" class="vp-onboard__panel">
          ...
          <p class="text-sm leading-relaxed mt-2">
            <b>Cascada</b>: scroll vertical cómodo en mobile. <b>Página</b>: una por viewport, con
            click y swipe. <b>Slider</b>: carrusel horizontal con snap.
          </p>

          <div
            class="font-mono text-[11px] uppercase tracking-[0.14em] leading-relaxed opacity-70 mt-3 space-y-1"
          >
          ...
          <button type="button" class="vp-onboard__close" @click="close">Empezar a leer</button>
        </div>
      </div>
    </Transition>
  </Teleport>
