import { api, buildAuthHeaders, type ApiClient } from '@/composables/services/shared/api.client';
import { createServiceError } from '@/composables/services/shared/service-error';
import { toServiceError } from '@/composables/services/shared/service-error.mapper';
import { failure, success, type ServiceResult } from '@/composables/services/shared/service-result';
