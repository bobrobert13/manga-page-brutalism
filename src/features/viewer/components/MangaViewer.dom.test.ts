...
import MangaViewer from '@/features/viewer/components/MangaViewer.vue';
import ViewerControls from '@/features/viewer/components/ViewerControls.vue';
import ViewerFeedback from '@/features/viewer/components/ViewerFeedback.vue';
import ViewerIndicator from '@/features/viewer/components/ViewerIndicator.vue';
import ViewerOnboarding from '@/features/viewer/components/ViewerOnboarding.vue';
import ViewerStage from '@/features/viewer/components/ViewerStage.vue';
